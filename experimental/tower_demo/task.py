...
class HackerNewsProcessor:
    ...
    def write_to_iceberg(self, stories: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            print(f"🔧 Debug: Creating table reference for '{table_name}' in namespace '{namespace}'")
...
class CogneeProcessor:
    ...
    def store_search_results_in_iceberg(self, search_results: Dict[str, str], dataset_name: str, articles_count: int) -> bool:
        ...
        try:
            ...
            print(f"✅ Successfully stored {len(records)} search results in Iceberg table: {namespace}.{table_name}")
            return True
