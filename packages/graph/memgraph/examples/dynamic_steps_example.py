...
Expertise in developing advanced algorithms and deploying
scalable models in production environments.
...
async def main(enable_steps):
    ...
    if enable_steps.get("retriever"):
        ...
        cot_results = await cognee.search(
            ...
            query_text="Which data scientists have machine learning experience"
            "and what specific skills do they have?",
        )
